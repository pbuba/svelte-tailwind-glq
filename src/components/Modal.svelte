...
<div class="inline-block">
  ...
  {#if showModal}
    ...
    >
      <div class="relative w-96 my-6 mx-auto max-w-3xl">
        <!--content-->
        <form
        ...
        >
          ...
          >
            ...
            <button
              class="disabled:opacity-50 w-32 bg-indigo-500 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
              type="submit"
              disabled={loading}
            >
              {#if loading}
